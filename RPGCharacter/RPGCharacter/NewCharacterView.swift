...
struct NewCharacterView: View {
    ...
    @ViewBuilder func getCharacterImage(character: Character) -> some View {
        if let image =  character.image {
            ...
            Image(systemName: character.rpgClass.defaultImage)
                .resizable()
                .foregroundStyle(.white)
    ...
    func createCharacter(_ character: Character) {
        NotificationCenter.default.post(
            name: Notification.Name(Keys.updateCharacter),
            object: nil,
            userInfo: [Keys.character : character])
        dismiss()
    }
}
